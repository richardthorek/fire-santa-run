...
describe('Integration: Real-Time Tracking (Mock BroadcastChannel)', () => {
  ...
  it('should broadcast location updates', (done) => {
  ...
  it('should support multiple viewers tracking same route', (done) => {
  ...
  it('should include waypoint progress in broadcasts', (done) => {
  ...
  it('should isolate broadcasts by route ID', (done) => {
  ...
  it('should complete full real-time tracking flow', (done) => {
